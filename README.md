...
docker buildx build . --platform linux/amd64,linux/arm64,windows/amd64,windows/arm64 -t vedph2020/cadmus-codicology-api:8.0.2 -t vedph2020/cadmus-codicology-api:latest --push
```
